            ...
            {details && <>
                <div className="py-10 flex flex-col md:flex-row ">
                    ...
                    <div className="w-full md:w-1/4 flex flex-col justify-center items-center">
                        <button type="button" className="shadow-sm border border-blue-500 bg-blue-500 text-white px-6 py-1 rounded-xl mb-3" onClick={(e)=>{
                             e.stopPropagation();
                        }}>Job details</button>
                        <button type="button" className={`shadow-sm rounded-xl border ${ saved ? 'bg-red-500 border-red-500 text-white' : 'border-blue-500 text-blue-500'}  px-6 py-1`} onClick={(e)=>{
                            e.stopPropagation();
                            setSave(o => !o)
